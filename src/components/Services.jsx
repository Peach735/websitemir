...
const SERVICES = [
  ...
  },
  {
    ...
    items: ['Тендеры и государственные закупки', 'Биржевые торги на БУТБ и брокерские услуги', 'Испытания и квалификация продукции', 'Приемка продукции и работа с рекламациями'],
  },
  {
