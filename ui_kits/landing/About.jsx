    ...
    <section className="section" id="about">
      <div className="container about__grid">
        <div className="about__body">
          ...
          <p className="body">
            Основатель компании более 18 лет работал в закупках металлопродукции
            на МАЗ — одном из крупнейших машиностроительных предприятий Беларуси.
            Этот опыт даёт редкое преимущество: взгляд изнутри закупочных служб,
            тендерных комиссий и контроля качества.
          </p>
          <p className="body">
